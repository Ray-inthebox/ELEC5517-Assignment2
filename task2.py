...
def myNetwork():
    ...
    net.addLink(s1, s3)
    net.addLink(s1, s4)
    s2h1 = {'bw':2,'loss':1,'delay':'5ms'}
    #s2h1 = {'bw':2,'loss':10,'delay':'5ms'}
    #s2h1 = {'bw':2,'loss':1,'delay':'50ms'}
    #s2h1 = {'bw':2,'loss':1,'delay':'5ms','max_queue_size':10}
    #s2h1 = {'bw':2,'loss':1,'delay':'5ms','max_queue_size':1}
    ...
    s4h9 = {'bw':600}
    net.addLink(s4, h9, cls=TCLink , **s4h9)
